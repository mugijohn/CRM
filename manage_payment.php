    ...
    <form action="" id="manage-payment">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control text-right" step="any" name="vat_paid"  value="<?php echo isset($vat_paid) ? $vat_paid :'' ?>" >
        </div>
        <div class="form-group">
            <label for="" class="control-label">Service Charge: </label>
            <input type="number" class="form-control text-right" step="any" name="service_charge_paid"  value="<?php echo isset($service_charge_paid) ? $service_charge_paid:'' ?>" >
        </div>
