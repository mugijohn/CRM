...
<hr>
											<div style="width: 600px; display: table-cell;" class="nav" display=""> 
												<div style="margin-top: 0px; margin-left: 0px;">
												<p><b>Service Fee </b> <br>
												<hr>
												<p><?php echo number_format($row['service_charge_paid'],2) ?></p>
												<hr>
												<p><b>TOTAL PAID </b> <br>
												<hr>
											...
											<p><b>Vat</b> <br>
											<hr>
												<p><?php echo number_format($row['vat_paid'],2) ?></p>
												
												<hr>
												<p><b><?php echo number_format($total_receipt,2) ?></b> <br>
												<hr>
												<hr>
											</div>
										</div>
						...
						<table class="table table-bordered">
							...
							<?php 
									...
									<tr>
										...
										<td><?php echo number_format($row['vat_paid'],2) ?></td>
										<td class="text-center"><?php echo number_format($total_receipt,2) ?></td>
									</tr>
