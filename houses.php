                  ...
                  <div class="card border-left-success shadow h-100 py-2">
					...
					<div class="card-body">
                            ...
                            <div class="form-group">
								...
								<input type="number" class="form-control text-right" name="vat" step="any" required="">
							</div>
							<div class="form-group">
								<label class="control-label">Service Charge</label>
								<input type="number" class="form-control text-right" name="service_charge" step="any" required="">
							</div>
							<div class="form-group">
								<label class="control-label">Total Payable</label>
								<input type="number" class="form-control text-right" name="total_payable" step="any" required="">
							</div>
					</div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Store #: <b><?php echo $row['house_no'] ?></b></p>
										<p><small>Store Name: <b><?php echo $row['cname'] ?></b></small></p>
										<p><small>Description: <b><?php echo $row['description'] ?></b></small></p>
										<p><small>Rent: <b><?php echo number_format($row['price'],2) ?></b></small></p>
										<p><small>Vat: <b><?php echo number_format($row['vat'],2) ?></b></small></p>
										<p><small>Service Fee: <b><?php echo number_format($row['service_charge'],2) ?></b></small></p>
										<p><small>Total Payable: <b><?php echo number_format($row['total_payable'],2) ?></b></small></p>
...
<script>
	...
	$('.edit_house').click(function(){
        ...
        cat.find("[name='vat']").val($(this).attr('data-vat'))
